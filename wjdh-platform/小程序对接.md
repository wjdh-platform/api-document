...
- [3列表页面](#3列表页面)
  - [3.1用户相关数据列表](#31用户相关数据列表)
    ...
    - [3.1.5添加家属的可选房间列表](#315添加家属的可选房间列表)
...
>url地址：<https://tc.mg.cool/api/v1/user/housesJiashuList>
...
字段|类型|是否必填|释义|选项
|:--|:--|:--|:--|:--
community_identifier|integer|必填|小区唯一编号，如晨曦家园是10002
...
role|string|必返|该用户在该房间的角色，如果是租客，就将稍后要选择的“与业主关系”写死为租客
