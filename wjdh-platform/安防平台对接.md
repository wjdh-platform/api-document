...
- [2订单支付流程](#2订单支付流程)
  ...
  - [2.2安防平台提供接口](#22安防平台提供接口)
    - [2.2.1接收缴费信息返回（功能未开发12月13日）](#221接收缴费信息返回功能未开发12月13日)
...
|:--|:--|:--|:--
house|针对房屋的收费|{'building_number':'1','unit_number':'1','floor_number':'1','house_number':'101'}|所有该房屋下的有权缴费者（业主授权）都会收到缴费通知
