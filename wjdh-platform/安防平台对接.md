...
- [1一标三实录入流程接口](#1一标三实录入流程接口)
  - [1.1安防平台提供接口](#11安防平台提供接口)
    ...
    - [1.1.2 通过手机号和姓名得到安防平台用户数据(2021年1月14日暂停使用本接口)](#112-通过手机号和姓名得到安防平台用户数据2021年1月14日暂停使用本接口)
      - [1.1.2.1头部信息](#1121头部信息)
      - [1.1.2.2携带数据](#1122携带数据)
      - [1.1.2.3返回数据](#1123返回数据)
      - [1.1.2.4结果示例](#1124结果示例)
      - [1.1.2.5接口附录](#1125接口附录)
    - [1.1.3 如果房屋存在业主，返回业主手机号(2021年1月14日暂停使用本接口)](#113-如果房屋存在业主返回业主手机号2021年1月14日暂停使用本接口)
...
- [5公告](#5公告)
  ...
  - [5.3更新公告状态](#53更新公告状态)
    ...
    - [5.3.4返回示例](#534返回示例)
- [6投诉建议](#6投诉建议)
  - [6.1查看投诉建议列表](#61查看投诉建议列表)
    - [6.1.1头部信息](#611头部信息)
    - [6.1.2携带数据](#612携带数据)
    - [6.1.3返回数据](#613返回数据)
    - [6.1.4返回示例](#614返回示例)
  - [6.2查看单独一条投诉建议](#62查看单独一条投诉建议)
    - [6.2.1头部信息](#621头部信息)
    - [6.2.2携带数据](#622携带数据)
    - [6.2.3返回数据](#623返回数据)
    - [6.2.4返回示例](#624返回示例)
  - [6.3更新投诉建议状态](#63更新投诉建议状态)
    - [6.3.1头部信息](#631头部信息)
    - [6.3.2携带数据](#632携带数据)
    - [6.3.3返回数据](#633返回数据)
    - [6.3.4返回示例](#634返回示例)
- [7访问后台](#7访问后台)
  - [7.1跳转到指定功能的后台](#71跳转到指定功能的后台)
    - [7.1.1头部信息](#711头部信息)
    - [7.1.2携带数据](#712携带数据)
    - [7.1.3返回数据](#713返回数据)
    - [7.1.4功能路由附录（2020年1月16日更新）](#714功能路由附录2020年1月16日更新)
...
``` json
{"community_identifier":"00001","building_number":1,"unit_number":1,"floor_number":2,"house_number":201,"idcard":"130302199211302519"}
...
>url:go.mgg.cool:9991/wjdhkj/token
...
### 1.1.2 通过手机号和姓名得到安防平台用户数据(2021年1月14日暂停使用本接口)
...
### 1.1.3 如果房屋存在业主，返回业主手机号(2021年1月14日暂停使用本接口)

>说明：通过社区标识、楼栋号码、单元号码、楼层号码、房屋号码，得到该房屋业主的数据

>请求方法：POST

>URL:(2021年1月14日暂停使用本接口)
...
连接所有智慧平台接口时，如果token值超过1小时会过期，会出现如下返回值
...
xiaoqu_id|integer|安防平台社区表的唯一标识|必填|如晨曦家园的唯一标识是“10002”
...

{
    "data": [
        ...
        },
        {
            "shenhe_id":3,
            "shenhe_type": "家属解绑",
            "shenhe_content":"{"community_identifier":"00001","building_number":1,"unit_number":1,"floor_number":2,"house_number":201,"idcard":"130302199211302519"}",
            "shenhe_status": "2",
            "shenhe_house_introduction": "晨曦家园1栋1单元1楼102号",
            "shenhe_action_introduction": "儿子正在申请：家属解绑",
            "shenhe_refuse_reason": null,
            "created_at": "2020年11月18日12:01:46",
            "updated_at": "2020年11月18日12:01:46"
        },
        {
            ...
            "shenhe_status": "2",
            "shenhe_house_introduction": "晨曦家园1栋1单元1楼102号",
            "shenhe_action_introduction": "新idid业主正在申请：替换业主",
            "shenhe_refuse_reason": null,
            "created_at": "2020年11月18日12:01:46",
            "updated_at": "2020年11月18日12:01:46"
        }
...
>URL:<https://tc.mg.cool/api/v1/wjdh/shenhe/update>
...
content|string|审核内容|非必填|见前言[审核数据](#shenhe_content)-解绑时可以不用传
refuse_reason|string|拒绝理由|非必填|
...
字段|格式|是否必填|释义|补充
|:--|:--|:--|:--|:--
xiaoqu_id|integer|必填|小区唯一值（如晨曦家园10002）|判断钱是要交给哪家收费主体的重要凭依
...
字段|格式|是否必填|释义|补充
|:--|:--|:--|:--|:--
xiaoqu_id|integer|必填|小区唯一值（如晨曦家园10002）|判断钱是要交给哪家物业的重要凭依
...
>url:<https://tc.mg.cool/api/v1/wjdh/announcements/list>
...
|:--|:--|:--|:--|:--
xiaoqu|string|必填|小区唯一标识|如晨熙家园00001
per_page|integer|否|每页显示的记录数量，不填默认20条
page|integer|否|第几页，不填默认第一页
...
字段|是否必返|格式|释义|补充
|:--|:--|:--|:--|:--
announcement_id|integer|必返|公告id|
date|string|必返|公告发布时间
top|boolean|必返|是否置顶，0不置顶1置顶
status|boolean|必返|关闭还是开启，0关闭，1是开启
manager|string|否|创建公告时可以填写公告发布者，不填写就默认是“XX小区物业”
logo|string|否|公告标头的logo，不填写就默认是小区的logo，小区的logo也没有的话，就为空
images|string|否|公告下部的图片列表
...
成功
{
    ...
    "data": {
        "announcements": [
            {
                ...
                "manager": null,
                "logo": null,
                "images": "http://face-100k.oss-cn-beijing.aliyuncs.com/wjdh-platform/face-photo/00001/1/1/2/201/WlowFoHfPOoZC6aHBU6jgBB28vSSiSu0KxsevwXF.png,http://face-100k.oss-cn-beijing.aliyuncs.com/wjdh-platform/face-photo/00001/1/1/2/201/WlowFoHfPOoZC6aHBU6jgBB28vSSiSu0KxsevwXF.png,http://face-100k.oss-cn-beijing.aliyuncs.com/wjdh-platform/face-photo/00001/1/1/2/201/WlowFoHfPOoZC6aHBU6jgBB28vSSiSu0KxsevwXF.png"
            },
            {
                "announcement_id": 6,
                "title": "杨哲测试公告1",
        ...
        "pages": {
            "current_page": 1,
            "first_page_url": "http://wjdh-platform.test/api/v1/wjdh/announcements/list?page=1",
            "from": 1,
            "last_page": 1,
            "last_page_url": "http://wjdh-platform.test/api/v1/wjdh/announcements/list?page=1",
            "next_page_url": null,
            "path": "http://wjdh-platform.test/api/v1/wjdh/announcements/list",
            "per_page": 15,
            "prev_page_url": null,
            "to": 8,
            "total": 8
    ...
    "message": "message编码Announcements151"
}
```
...
>url:<https://tc.mg.cool/api/v1/wjdh/announcement>
...
images|string|否|图片的url，多条url使用```,```隔开
order|boolean|是|权重
top|boolean|是|是否置顶
status|boolean|是|是否关闭
manager|string|否|公告发布人，默认为“XXX物业”
logo|string|否|公告标头的logo，不填写就默认是小区的logo，小区的logo也没有的话，就为空
date|string|是|格式如```2020-12-01```
...
成功
{
    ...
    "token_expired": 1,
    "msg": "更新公告成功",
    "message": "message编码Announcements215",
    "data": ""
}
```
...
>url:<https://tc.mg.cool/api/v1/wjdh/suggestions/list>
...
字段|格式|是否必返|释义|补充
|:--|:--|:--|:--|:--
suggestion_id|integer|必返|投诉建议记录id|
top|boolean|必返|是否置顶，0不置顶1置顶
status|boolean|必返|关闭还是开启，0关闭，1是开启
category|string|必返|投诉类别
content|string|必返|投诉内容
reply|string|必返|物业回复
date|string|必返|用户提交投诉建议的时间
...
成功
{
        ...
        "suggestions": [
            {
                ...
                "status": 0,
                "reply": "回复测试2",
                "date": "2020年12月24日12:46:30"
            }
        ],
        "pages": {
            "current_page": 1,
            "first_page_url": "http://wjdh-platform.test/api/v1/wjdh/suggestions/list?page=1",
            "from": 1,
            "last_page": 1,
            "last_page_url": "http://wjdh-platform.test/api/v1/wjdh/suggestions/list?page=1",
            "next_page_url": null,
            "path": "http://wjdh-platform.test/api/v1/wjdh/suggestions/list",
            "per_page": "1",
            "prev_page_url": null,
            "to": 1,
            "total": 1
    ...
    "message": "message编码Suggestions140"
}
```
...
>url:<https://tc.mg.cool/api/v1/wjdh/suggestion>
...
字段|格式|是否必填|释义|补充
|:--|:--|:--|:--|:--
suggestion_id|integer|必填|投诉建议id|
...
成功
{
    ...
    "message": "message编码Suggestions167"
}
```
...
成功
{
    ...
    "data": {
        ...
        "status": "0",
        "reply": "回复测试2",
        "created_at": "2020年12月24日12:46:30"
    },
    "message": "message编码Suggestions167"
}
```
...
>url:<https://tc.mg.cool/api/v1/wjdh/backend?route=announcements>
...
字段|格式|是否必填|释义|补充
|:--|:--|:--|:--|:--
route|string|必填|跳转的功能路由|

### 7.1.3返回数据

> 后台页面

### 7.1.4功能路由附录（2020年1月16日更新）

功能名称|路由参数
|:--|:--
订单|orders
账单|payments
模块管理|community-modules
公告|announcements
保修|repairs
投诉建议|suggestions
体温上报|temperatures
